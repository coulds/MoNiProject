...
public class utilts extends View {
    ...
    public utilts(Context context) {
        super(context);
    }

    public utilts(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public utilts(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
